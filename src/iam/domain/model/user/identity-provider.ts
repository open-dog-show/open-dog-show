...
import type { UserProfileFacts } from './user.js';
 ...
 * facts refreshed on every login (carried as the {@link UserProfileFacts} base,
 * so a `ProviderClaims` is directly usable wherever profile facts are needed).
 *
 ...
 */
export interface ProviderClaims extends UserProfileFacts {
    readonly sub: string;
}
